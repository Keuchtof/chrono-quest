                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-1.5 mt-0.5">
                        {s.tag
                          ? <span className="text-xs px-2 py-0.5 rounded-full" style={{ backgroundColor: color.main + '22', color: color.main }}>{s.tag}</span>
                          : <button
                    ...
                    <button
                      onClick={() => setEditSession(s)}
                      className="w-7 h-7 flex items-center justify-center text-gray-300 hover:text-gray-500 rounded-lg"
                    >✏️</button>
                    <button
